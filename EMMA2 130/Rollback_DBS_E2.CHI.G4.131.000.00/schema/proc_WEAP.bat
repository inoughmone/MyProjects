...
echo   1 of  1 START LOAD: ITSR013528_Revoke_WSM.SQL  >> PROCS_"%4".OUT
echo   1 of  1 START LOAD: ITSR013528_Revoke_WSM.SQL  
echo Creating Temp Script... started 
if NOT "%4" == "" echo USE %4  > TempSQL.SQL 
if NOT "%4" == "" echo GO     >> TempSQL.SQL 
type "ITSR013528_Revoke_WSM.SQL"   >> TempSQL.SQL 
echo Running Script... ITSR013528_Revoke_WSM.SQL		
isql -U%1 -P%2 -S%3 -Jcp850 -iTempSQL.SQL >> PROCS_"%4".OUT
echo   1 of  1 END LOAD: ITSR013528_Revoke_WSM.SQL  
echo   1 of  1 END LOAD: ITSR013528_Revoke_WSM.SQL  >> PROCS_"%4".OUT
